FROM ubuntu:24.04
RUN export DEBIAN_FRONTEND=noninteractive; apt update; apt install -y curl make git-core cmake python3 sudo wget bzip2 xz-utils libreadline8 libusb-0.1-4 tmux libmpc3 mono-devel
